...
import 'package:cyberlife/views/finger-escape/finger_escape_test.dart';
import 'package:cyberlife/widgets/appbar.dart';
import 'package:flutter/material.dart';
import 'package:video_player/video_player.dart';

class FingerEscapeVideoInstructions extends StatefulWidget {
  const FingerEscapeVideoInstructions({Key? key}) : super(key: key);

  @override
  _FingerEscapeVideoInstructionsState createState() =>
      _FingerEscapeVideoInstructionsState();
}

class _FingerEscapeVideoInstructionsState
    extends State<FingerEscapeVideoInstructions> {
  final defaultVideoPath = "assets/videos/sample.mp4";
  final title = "Finger Release Test";
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset(defaultVideoPath);
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const FingerEscapeTest(),
                      ));
