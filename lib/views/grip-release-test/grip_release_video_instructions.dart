...
class GripReleaseVideoInstructions extends StatefulWidget {
  const GripReleaseVideoInstructions({Key? key}) : super(key: key);

  @override
  _GripReleaseVideoInstructionsState createState() =>
      _GripReleaseVideoInstructionsState();
}

class _GripReleaseVideoInstructionsState
    extends State<GripReleaseVideoInstructions> {
  final defaultVideoPath = "assets/videos/sample.mp4";
  final title = "Grip Release Test";
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const GripReleaseTest(),
                      ));
